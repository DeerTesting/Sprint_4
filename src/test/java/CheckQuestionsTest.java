...
public class CheckQuestionsTest {
    ...
    public CheckQuestionsTest(int ElementNumber, String ExpectedText){
    ...
    public void startUp() {
        ...
        public void checkInnerText() {
            ...
            mainPage.scroll();
            mainPage.openQuestion(ElementNumber);
            boolean isPresented = mainPage.visibleAnswer(ExpectedText);
